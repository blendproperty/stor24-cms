  ...
  collections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "source", type: "select", options: ["web_form", "whatsapp", "email", "walk_in", "referral"], defaultValue: "web_form" },
        { name: "unitSize", type: "select", options: ["small", "medium", "large", "extra_large"] },
        { name: "moveInDate", type: "date" },
        { name: "score", type: "number" },
        { name: "status", type: "select", options: ["new", "quoted", "viewing", "converted", "lost"], defaultValue: "new" },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "stage", type: "select", options: ["new_lead", "quoted", "viewing_scheduled", "converted", "active", "churned", "lost"], defaultValue: "new_lead", required: true },
        { name: "unitSize", type: "select", options: ["small", "medium", "large", "extra_large"] },
    ...
    },
    {
      ...
      fields: [
        { name: "contact", type: "relationship", relationTo: "contacts", required: true },
        { name: "type", type: "select", options: ["note", "email", "call", "whatsapp", "viewing", "status_change"], required: true },
